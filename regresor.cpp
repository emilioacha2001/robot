...
int main(int argc, char *argv[]) {
    ...
    coeficientes = arma::inv(A) * y;
    cout << "Coeficientes del regresor: " << coeficientes.t() << endl;

    ofstream outFile("m_config/m2_regresor.txt");
    if (!outFile) {
    ...
    ofstream coefFile("m_config/m2_f_delta_speed.txt");
    ...
    // plot "m_config/m1_regresor.txt" using 1:2 with lines title "Original Data" pointtype 7, "m_config/m1_regresor.txt" using 1:3 with lines title "Polynomial Fit" linecolor "red"
    // plot "m_config/m1_regresor_inversor.txt" using 1:2 with lines title "Original Data" pointtype 7, "m_config/m1_regresor_inversor.txt" using 1:3 with lines title "Polynomial Fit" linecolor "red"
